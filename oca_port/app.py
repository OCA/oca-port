...
class App(Output):
    ...
    def _prepare_repos(self):
        ...
        if not self.destination:
            ...
            # Whenever is not set, target parameters will be used,
            # except the branch name that will be generated by the specific tool.
            self.destination = make_gh_info(
                "destination",
                self.target._ref,
                # Use destination_remote parameter if set, or fallback on target one
